...
const ButtonGroup = () => {
  return (
    <div className="flex items-center justify-between mt-[6px] sm:mt-[25px] mb-[21px] gap-[21px] sm:gap-[30px]">
      <button className="flex-1 px-[17px] py-[10px] rounded-[6px] bg-gradient-to-r from-[#1A86A1] via-[#4245CD] to-[#FF15E5] text-white text-sm sm:text-lg lg:text-base font-semibold leading-[21px] sm:leading-[27px] text-center">
        Add to cart
      </button>
